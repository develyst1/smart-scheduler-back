...
// the CHECK as witness; 52 = 52; the CHECK ⇔ `SUBJECT_KINDS` by value), the two readers carry `kind` (`teacher.subjects[]`,
...
describe("🔴 the migration — 0050, counted, the column with its default on a small table, the CHECK NOT VALID → VALIDATE = the witness; the CHECK ⇔ the set", () => {
  ...
  test("52 = 52: `0050_subject_kind` is the 51st file, idx 50 (TASK-439 added 0051 after it); 'expects 51'; the four statements", () => {
