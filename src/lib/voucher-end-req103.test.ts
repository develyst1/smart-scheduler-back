...
// columns + the CHECK ⇔ `END_REASONS` as witness; 53 = 53), `voucherStatus` (ENDED > EXPIRED > EXHAUSTED > ACTIVE) on the DTO,
...
describe("🔴 the migration — 0051, counted, three nullable columns on a small table, the CHECK NOT VALID → VALIDATE = the witness; the CHECK ⇔ END_REASONS", () => {
  ...
  test("53 = 53: `0051_voucher_end` is the 52nd file, idx 51 (TASK-443 added 0052 after it); 'expects 52'; the six statements", () => {
