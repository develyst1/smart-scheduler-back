...
// the four sale items, the RBAC keys (13 menus / 54 acts), the nine routes through the ROOT app. 49 = 49.
...
describe("🔴 the migration — 0042, counted, witnessed by the UNIQUE index, no expiry BY STRUCTURE, the `students` lock named (source)", () => {
  ...
  test("49 = 49: `0042_camp` is the 43rd file, idx 42 (TASK-403 added 0043 after it); the order 0038 → 0042 named in the header", () => {
