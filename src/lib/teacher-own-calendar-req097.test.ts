...
// the 4th reason; the FAMILY's NEW notice as a placeholder kind; the other teachers' coach notice). 50 = 50.
...
describe("🔴 the migration — 0044, counted, ONE nullable FK column + the partial unique index LAST = the witness (source)", () => {
  ...
  test("50 = 50: `0044_user_teacher_link` is the 45th file, idx 44 (TASK-410/411 added 0045/0046 after it); 'expects 45' in the header", () => {
