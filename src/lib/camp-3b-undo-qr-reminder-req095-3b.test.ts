...
// reminder's SEND PATH behind `camp_reminder_enabled` (default off) with PLACEHOLDER labels. Migration `0043` — 49 = 49.
...
describe("🔴 the migration — 0043, counted, three NULLABLE adds, the partial unique index LAST = the witness (source)", () => {
  ...
  test("49 = 49: `0043_camp_checkin_token` is the 44th file, idx 43 (TASK-406 added 0044 after it); the order 0038 → 0043 and 'expects 44' in the header", () => {
