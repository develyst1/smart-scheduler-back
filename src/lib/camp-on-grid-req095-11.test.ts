...
// swap route, `CAMP_ROW_OWNED` at every human row write (a table), the reminder fold, no money by absence. 48 = 48.
...
describe("🔴 the migration — 0047, counted, the day table + the window + the link + the partial index LAST = the witness; the SHARE lock named (source)", () => {
  ...
  test("48 = 48: `0047_camp_week_days` is the 48th file, idx 47, the last; 'expects 48'", () => {
