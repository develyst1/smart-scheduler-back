...
describe("🔑 the group DTO carries `priceGroup` from the resolver's own mapping; `ensure-sale-items --dry-run` writes nothing", () => {
  ...
  test("52 = 52 — 2b added no migration (TASK-401 added 0042, TASK-403 added 0043, TASK-406 added 0044, TASK-410 added 0045, TASK-411 added 0046, TASK-418 added 0047, TASK-420 added 0048, TASK-428 added 0049, TASK-437 added 0050, TASK-439 added 0051)", () => {
